...
<body>
    ...
    <div class="container">
        ...
        <h3>Quelle table de multiplication souhaitez-vous consulter?</h3>
        <?php
        $mulplicateurMax = 12;
        $multiplicateur = 1;
        for ($i = 1; $i <= $mulplicateurMax; $i++)
        {
            ?>
            <a href="tableMultiplication.php?nombre= <?= $multiplicateur ?>">Table de <?= $multiplicateur ?></a>
            <br/>
